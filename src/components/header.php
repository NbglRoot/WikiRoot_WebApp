    ...
    <nav class="navbar navbar-expand-sm navbar-dark navbar__preferences">
      <div class="container-fluid">
        ...
        <div
          ...
          id="navbarID">
          <form action="src/components/articles/articlesPage.php" method="GET" class="m-2">
              ...
              <div class="dropdown dropstart open">
                ...
                <div class="dropdown-menu" aria-labelledby="userOptions">
                  ...
                  if (strtolower($_SESSION['userRole']) == "admin") { ?>
                    <a class="dropdown-item" href="src/components/admin_profile/administratorDDBB.php?userManagement">Gestionar Usuarios</a>
                    <a class="dropdown-item" href="src/components/admin_profile/administratorDDBB.php?articlesManagement">Gestionar Articulos</a>
                  <?php } ?>
                  <a class="dropdown-item" href="src/components/articles/articlesPage.php?createNewArticle">Crear Articulo</a>
                  <a class="dropdown-item" href="src/components/users_profiles/userProfile.php">Perfil</a>
                  <?php
